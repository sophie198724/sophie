...
<style type="text/css">
	body{background:url(<?php echo IMG_PATH?>admin_img/login_bodybg.jpg) center top no-repeat;font-family:"microsoft yahei";}
	div{overflow:hidden; *display:inline-block;}div{*display:block;}
	.login_box{background:url(<?php echo IMG_PATH?>admin_img/login_bg.png) no-repeat; width:835px; height:412px; overflow:hidden; position:absolute; left:50%; top:50%; margin-left:-417px; margin-top:-206px;}
	.login_iptbox{bottom:52px;_bottom:34px;color:#FFFFFF;font-size:12px;height:30px;left:50%;
margin-left:-280px;position:absolute;width:560px; overflow:visible;}
	...
	.login_tj_btn{ background:url(<?php echo IMG_PATH?>admin_img/login_dl_btn.png) no-repeat 0px 0px; width:52px; height:24px; margin-left:16px; border:none; cursor:pointer; padding:0px; float:right;}
	...
	.cr{font-size:14px;font-style:inherit;text-align:center;color:#fff;width:100%; position:absolute; bottom:18px;}
