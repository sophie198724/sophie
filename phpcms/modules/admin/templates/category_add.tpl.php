...
<table width="100%" class="table_form ">
 <tr>
	...
	<tr>
        ...
        <td>
		<textarea name="info[description]"  style="width:300px;height:60px;"><?php echo $description;?></textarea>
		</td>
      </tr>
