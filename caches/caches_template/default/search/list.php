<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><?php include template('search', 'header'); ?>
	<div class="clr sr_body sr_list">
    	<div class="sr_main">
            ...
            <div class="wrap sr_logo" style="min-height:100px;">
            	
                <div class="l" style="margin:80px auto 0;float:none">
                	<div class="sr_frm_box">
						<form name="search" type="get">
                        <div class="sr_frmipt" style="margin:0 auto;float:none">
                    ...
                    <div class="jg" style="text-align:center">获得约 <?php echo $totalnums;?> 条结果 （用时<?php echo sprintf("%01.2f", $execute_time);?> 秒）</div>
                </div>
            </div>
            <div class="brd1s"></div>
