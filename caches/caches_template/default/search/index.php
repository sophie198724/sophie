<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><?php include template('search', 'header'); ?>
	<div class="clr sr_body">
    	<div class="sr_main">
            ...
            <div class="sr_logo"><a href="javascript:;"></a></div>
            ...
            <div class="sr_frm">
            	<div class="sr_frm_box">
                	<div class="sr_frmipt"><input type="text" name="q" id="q" class="ipt" placeholder="&nbsp;搜寻中信蓝海集团！"><div class="sp" id="aca">▼</div><input type="submit" class="ss_btn" value="搜 索"></div>
                </div>
