...
<div style="padding:8px 10px; clear:both;">
   ...
   <img src="/statics/images/a238_00.gif" width="100%" />
            <?php
    $i = 1;
?>

             <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"mobile\" data=\"op=mobile&tag_md5=f890c342aa7a1829bb3e0da79427a767&action=lists&catid=%24catid&order=listorder+desc&moreinfo=1&num=18\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$mobile_tag = pc_base::load_app_class("mobile_tag", "mobile");if (method_exists($mobile_tag, 'lists')) {$data = $mobile_tag->lists(array('catid'=>$catid,'order'=>'listorder desc','moreinfo'=>'1','limit'=>'18',));}?>
...
?>
                ...
                $j = 1;
                ?>
               <img src="/statics/images/a238_0<?php echo $i; ?>.gif" width="100%" />
                ...
                <a href="<?php echo show_url($rr[catid],$rr[id]);?>"><img src="<?php echo $rr['thumb'];?>" style="width: 100%"></a>
                 <a href="<?php echo show_url($rr[catid],$rr[id]);?>"><span style="margin-left: 50%; color:black;  font-size: 12px;"><?php echo $rr['title'];?></span></a>
                <?php
                 }
                 else
                 {
