...
<div id="content">
	...
	<div class="col-left left-nav">
    	<h3 style="background-color:#b3291e;background: url(../images/leftbg02.jpg) no-repeat left top #b3291e !important;
    line-height: 35px;
    padding: 15px 5px;
    font-weight: bold;
    text-align: center;font-size: 20px;
    color: #fff;"><?php echo $CATEGORYS[$CAT['parentid']]['catname'];?></h3><br/>
    	<ul class="content">
        ...
        <div class="content">
		  <DIV class=nymore style="text-indent:5px">当前位置：<a href="<?php echo siteurl($siteid);?>">首页</a>&gt;<?php echo catpos($catid);?></DIV>
		   ...
		   <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>   
            <li>
						<a class="newsList-title" href="<?php echo $r['url'];?>" style="float:left;margin-right:5px;"><img src="<?php echo thumb($r[thumb],150,100);?>" /></a>
