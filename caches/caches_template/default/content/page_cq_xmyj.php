...
.footer p.info a{color:#666;}
 ...
 <div class="ban3">
        ...
        <img src="<?php echo $CATEGORYS[$CATEGORYS[$CAT['parentid']]['parentid']]['image'];?>"  />
...
<div id="content">
	...
	<div class="col-left left-nav">
    	...
    	<ul class="content">
        	<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=d6d847c513bcdb4825d2d5774ed6cae7&action=category&catid=%24CATEGORYS%5B%24CAT%5Bparentid%5D%5D%5Bcatid%5D&num=30&siteid=%24siteid&order=listorder+ASC\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'category')) {$data = $content_tag->category(array('catid'=>$CATEGORYS[$CAT[parentid]][catid],'siteid'=>$siteid,'order'=>'listorder ASC','limit'=>'30',));}?>
  ...
  <div class="col-auto">
    	 ...
    	 <DIV class=nymore>当前位置：<a href="<?php echo siteurl($siteid);?>">首页</a><span> > </span><?php echo catpos($catid);?> <span style="float:right;margin-right:180px;"><a href="<?php echo $CATEGORYS[$CATEGORYS[$parentid]['parentid']]['url'];?>">返回上一级</a></span></DIV>
        <div class="content">
           <?php echo $content;?>
        </div>
    </div>
