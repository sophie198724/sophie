...
<div class="ban3">
         <img src="<?php echo $CATEGORYS['112']['image'];?>" >
  </div>
<div id="content">
   
	<div class="col-left left-nav">
    	<h3 style="background-color:#29166f; color:#FFF" align="center"><?php echo $CATEGORYS[$CATEGORYS[$parentid]['parentid']]['catname'];?></h3><br/>
...
<?php include template("content","b_r"); ?>
  ...
  <div class="col-auto">
    	...
    	<DIV class=nymore>当前位置：<a href="<?php echo siteurl($siteid);?>">首页</a><span> > </span><?php echo catpos($catid);?> <span style="float:right;margin-right:160px;"><a href="?m=content&c=index&a=lists&catid=112">返回上一级</a></span> </DIV>
        <div class="content">
           <?php echo $content;?>
        </div>
    </div>
