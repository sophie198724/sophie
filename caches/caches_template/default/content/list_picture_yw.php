...
<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=bbb4fc7fe2e7b4ea2427192e2301e691&action=lists&catid=%24catid&num=12&order=listorder&moreinfo=1&page=%24page\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$pagesize = 12;$page = intval($page) ? intval($page) : 1;if($page<=0){$page=1;}$offset = ($page - 1) * $pagesize;$content_total = $content_tag->count(array('catid'=>$catid,'order'=>'listorder','moreinfo'=>'1','limit'=>$offset.",".$pagesize,'action'=>'lists',));$pages = pages($content_total, $page, $pagesize, $urlrule);$data = $content_tag->lists(array('catid'=>$catid,'order'=>'listorder','moreinfo'=>'1','limit'=>$offset.",".$pagesize,'action'=>'lists',));}?>

<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
		
          
			 <div class="i-box" style="width:25%;height:200px; margin:0 5px 20px 40px;">
                 <a href="<?php echo $r['url'];?>"><img src="<?php echo $r['thumb'];?>" alt="" style="width:240px;height:250px border:1px solid #ccc;"></a>
                  <a href="<?php echo $r['url'];?>"><p align="center" style="margin:0;padding:2px;"><?php echo str_cut($r[title],43,'');?></p></a>
