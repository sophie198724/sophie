...
<div id="content">
	<div class="col-left left-nav">
    	<h3 style="background-color:#29166f">中信蓝海</h3><br/>
    	...
    	<ul class="content">
			...
			<?php $n=1;if(is_array($data)) foreach($data AS $c) { ?>
			   <li><a  <?php if($catid == $c[catid]) { ?> class="on" style="background-color:#29166f" <?php } ?> href="<?php echo $c['url'];?>"><?php echo $c['catname'];?></a>				
            <?php $n++;}unset($n); ?>
  ...
  <div class="col-auto">
   <?php if($CATEGORYS[$catid][parentid]) { ?>
    	<img src="<?php echo $CATEGORYS[$CATEGORYS[$catid]['parentid']]['image'];?>" width="659" height="171" />
	 <?php } else { ?>
