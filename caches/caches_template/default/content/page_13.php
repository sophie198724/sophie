...
<div id="content">
	<div class="col-left left-nav">
    	<h3 style="background:url(<?php echo IMG_PATH;?>v9/left.jpg) no-repeat left top #005e3c !important"><?php echo $CAT['catname'];?> </h3><br/>
    	<ul class="content">
			...
			<?php $n=1;if(is_array($data)) foreach($data AS $c) { ?>
			   <li class="lvse"><a  <?php if($catid == $c[catid]) { ?> class="on" style="background-color:#005e3c;" <?php } ?> href="<?php echo $c['url'];?>"><?php echo $c['catname'];?></a>
			     <!--<ul>
