...
<div id="content">
  ...
  <div class="col-auto">
        ...
        <div class="content" style="margin-top:50px;">
					...
					<ul>
					<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=d872de28bceeb1058b8c546f0232dc46&action=lists&catid=169&siteid=%24siteid&order=listorder+ASC\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$data = $content_tag->lists(array('catid'=>'169','siteid'=>$siteid,'order'=>'listorder ASC','limit'=>'20',));}?>
					<?php $n=1;if(is_array($data)) foreach($data AS $v) { ?>

                    <li style="float:left;margin:10px 20px;width:160px;height:81px;text-align:center;list-style:none;border:0;"><img src="<?php echo $v['thumb'];?>" width="160" height="51"/><div style="margin-top:10px;font-size:14px;"><?php echo $v['title'];?></div></li>
