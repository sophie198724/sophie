...
<div id="content">
	...
	<div class="col-left left-nav">
    	...
    	<h4 style="background-color:#b3291e;background: url(../images/leftbg02.jpg) no-repeat left top #b3291e !important;
    line-height: 35px;
    padding: 15px 5px;
    font-weight: bold;
  ...
  <div class="col-auto">
       <DIV class=nymore>当前位置：<a href="<?php echo siteurl($siteid);?>">首页</a> &gt;<a href="<?php echo $CATEGORYS[$CAT['parentid']]['url'];?>"><?php echo $CATEGORYS[$CAT['parentid']]['catname'];?> </a>&gt; <?php echo $CATEGORYS[$catid]['catname'];?> </DIV>
    	    <div class="product-box">
                    <p style="z-indent:2em;"><?php echo $CATEGORYS[$catid]['description'];?></p>
...
<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
			 ...
			 <div class="i-box" style="width:33%;height:300px; ">
                 <img src="<?php echo $r['thumb'];?>" alt="" style="width:300px;height:250px border:1px solid #ccc;">
                    <p align="center" style="margin:0;padding:10px;"><?php echo $r['title'];?></p>
