...
<div id="content">
	...
	<div class="col-left left-nav">
    	<h3 style="background-color:#29166f;"><?php echo $CATEGORYS[$CAT['parentid']]['catname'];?><br><?php echo $CATEGORYS[$CAT['parentid']]['catdir'];?></h3>
		<br />
    	<ul class="content">
  ...
  <div class="col-auto">
  	 <DIV class=nymore>当前位置：<a href="<?php echo siteurl($siteid);?>">首页</a> &gt;<a href="<?php echo $CATEGORYS['154']['url'];?>"><?php echo $CATEGORYS[$CAT['parentid']]['catname'];?></a>&gt; <?php echo $CATEGORYS[$catid]['catname'];?> </DIV>
        <div class="clear"></div>
        <div class="content">
