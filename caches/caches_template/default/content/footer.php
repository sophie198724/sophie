<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><div class="footerWrapper">
	<div class="footer">
        ...
        <div class="sitemap">
        	<div class="col1">
                ...
                <ul>
                	...
                	<li style="margin-left:50px;"><a href="http://wpa.qq.com/msgrd?v=3&uin=98246262&site=qq&menu=yes"><img src="<?php echo IMG_PATH;?>images/qq.png"></a><div align="center" style="font-size:14px">QQ客服</div></li>
        ...
        <hr />
        <div class="copyright">
		<img src="<?php echo IMG_PATH;?>images/gongshang.png" style="float:left; margin-top: -20px;
">
