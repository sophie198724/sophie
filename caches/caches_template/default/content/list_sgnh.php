...
$odd = $i % 2 == 0 ? "odd" : "even";
?>
            <div style="height:108px;"class="list-cat-bg  chunk_<?php echo $catid;?>_<?php echo $i;?>">


            </div>

            <div style="width: 900px;" class="iblock five_2-3 five_<?php echo $odd;?>">
                <?php
                $j = 1;
                ?>
                <?php $n=1;if(is_array($r)) foreach($r AS $rr) { ?>
                <div class="five_<?php echo $j;?> b"><a href="<?php echo $rr['url'];?>"><img src="<?php echo $rr['thumb'];?>" style="width: 100%"></a></div>
                <?php
                    $j++;
                ?>
                <?php $n++;}unset($n); ?>
