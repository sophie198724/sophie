...
<div id="content">
	<div class="col-left left-nav">  
    	<h4 style="background-color:#28166f;background: url(../images/leftbg02.jpg) no-repeat left top #b3291e !important;
    line-height: 35px;
    padding: 15px 5px;
    font-weight: bold;
    text-align: center;font-size: 20px;
    color: #fff;"><?php echo $CATEGORYS[$CAT['parentid']]['catname'];?><br></h4><br/>
        <ul class="content">
  ...
  <div class="col-auto">
       <DIV class=nymore>当前位置：<a href="<?php echo siteurl($siteid);?>">首页</a> &gt;<a href=" <?php echo $CATEGORYS[$CAT['parentid']]['url'];?> "> <?php echo $CATEGORYS[$CAT['parentid']]['catname'];?> </a> &gt; <?php echo $CATEGORYS[$catid]['catname'];?> </DIV>
       <h1 class="title" align="center"><?php echo $title;?></h1>
	   <p align="center" style="padding: 10px 0;">时间：<?php echo date('Y-m-d',$r[inputtime]);?>&nbsp;&nbsp;&nbsp;来源：<?php echo $copyfrom;?></p><br>
		...
		<p class="f14">
                <strong style="float:left;">上一篇：</strong><a href="<?php echo $previous_page['url'];?>"><?php echo $previous_page['title'];?></a><br />
                <p style="float:right;font-size: 14px"><strong >下一篇：</strong><a href="<?php echo $next_page['url'];?>" ><?php echo $next_page['title'];?></a></p>
       </p>
    </div>
 </div>
