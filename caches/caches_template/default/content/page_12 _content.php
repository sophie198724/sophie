...
<div id="content">
	...
	<div class="col-left left-nav">
    	<h3 style="background-color:#29166f"><?php echo $CATEGORYS[$CAT['parentid']]['catname'];?> </h3><br/>
    	<ul class="content">
        	<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=4a6a6d4ce106219e55835689879b020e&action=category&catid=%24CATEGORYS%5B%24CAT%5Bparentid%5D%5D%5Bcatid%5D&num=12&siteid=%24siteid&order=listorder+ASC\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'category')) {$data = $content_tag->category(array('catid'=>$CATEGORYS[$CAT[parentid]][catid],'siteid'=>$siteid,'order'=>'listorder ASC','limit'=>'12',));}?>
